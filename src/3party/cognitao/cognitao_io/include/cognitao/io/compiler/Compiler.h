...
public:
	typedef boost::shared_ptr<cognitao::machine::MachineDefinitionRef> Ptr2Machine;
	typedef boost::shared_ptr<CompiledData> Ptr2CompiledData;
	typedef list< boost::shared_ptr<cognitao::machine::MachineDefinitionRef> > ListOfMachines;
	typedef list< boost::shared_ptr<CompiledData> > ListOfCompiledData;
