...
void ComponentMain::handleExecuteWorkSequenceCommand(config::WSM::sub::ExecuteWorkSequenceCommand& msg)
{
	std::cout<< "WSM say:" << msg.data << std::endl;
}
	

void ComponentMain::handlePosAttVel(config::WSM::sub::PosAttVel& msg)
{
	std::cout<< "WSM say:" << msg.data << std::endl;
}
	

void ComponentMain::handleWiresLengths(config::WSM::sub::WiresLengths& msg)
{
	std::cout<< "WSM say:" << msg.data << std::endl;
}
