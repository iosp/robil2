	...
	: _inited(init(argc, argv)), _comp(comp)
{
	...
	_sub_PerVelocity=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"SMME","PerVelocity","sub"), 10, &RosComm::PerVelocityCallback,this));
...
void RosComm::PerVelocityCallback(const config::SMME::sub::PerVelocity::ConstPtr &msg)
{
