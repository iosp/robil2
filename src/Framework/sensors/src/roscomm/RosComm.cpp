...
RosComm::RosComm(ComponentMain* comp,int argc,char** argv)
{
  ...
  _comp=comp;
	...
	_pub_Sensor_INSGPS=ros::Publisher(_nh.advertise<config::SENSORS::pub::Sensor_INSGPS>(fetchParam(&_nh,"SENSORS","Sensor_INSGPS","pub"),10));
}
RosComm::~RosComm()
{
}
...
void RosComm::publishSensor_INSGPS( config::SENSORS::pub::Sensor_INSGPS &msg)
{
