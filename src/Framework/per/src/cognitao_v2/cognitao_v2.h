...
#ifndef SRC_COGNITAO_V2_COGNITAO_V2_H_
#define SRC_COGNITAO_V2_COGNITAO_V2_H_
...
public:
	...
	virtual	void on_match(const cognitao::machine::Event& original, const cognitao::machine::Event& stranger){};
...
#endif /* SRC_COGNITAO_V2_COGNITAO_V2_H_ */
