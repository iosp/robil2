...
RosComm::RosComm(ComponentMain* comp,int argc,char** argv)
{
  ...
  _comp=comp;
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PER","Sensor_SICK","sub"), 10, &RosComm::Sensor_SICKCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PER","Sensor_IBEO","sub"), 10, &RosComm::Sensor_IBEOCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PER","Sensor_CAM_R","sub"), 10, &RosComm::Sensor_CAM_RCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PER","Sensor_CAM_L","sub"), 10, &RosComm::Sensor_CAM_LCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PER","Sensor_WIRE","sub"), 10, &RosComm::Sensor_WIRECallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PER","Sensor_INSGPS","sub"), 10, &RosComm::Sensor_INSGPSCallback,this));
...
void RosComm::Sensor_INSGPSCallback(const config::PER::sub::Sensor_INSGPS::ConstPtr &msg)
{
