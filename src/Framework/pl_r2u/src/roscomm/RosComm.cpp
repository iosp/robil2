...
RosComm::RosComm(ComponentMain* comp,int argc,char** argv)
{
  ...
  _comp=comp;
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PL_R2U","TrottleEffort","sub"), 10, &RosComm::TrottleEffortCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PL_R2U","SteeringEffort","sub"), 10, &RosComm::SteeringEffortCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PL_R2U","JointsEffort","sub"), 10, &RosComm::JointsEffortCallback,this));
