...
RosComm::RosComm(ComponentMain* comp,int argc,char** argv)
{
  ...
  _comp=comp;
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"LLI","TrottleEffort","sub"), 10, &RosComm::TrottleEffortCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"LLI","SteeringEffort","sub"), 10, &RosComm::SteeringEffortCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"LLI","JointsEffort","sub"), 10, &RosComm::JointsEffortCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"LLI","Teleoperation","sub"), 10, &RosComm::TeleoperationCallback,this));
