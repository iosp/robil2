...
RosComm::RosComm(ComponentMain* comp,int argc,char** argv)
{
  ...
  _comp=comp;
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"MAP","BladePosition","sub"), 10, &RosComm::BladePositionCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"MAP","PosAttVel","sub"), 10, &RosComm::PosAttVelCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"MAP","Laser","sub"), 10, &RosComm::LaserCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"MAP","Camera","sub"), 10, &RosComm::CameraCallback,this));
