...
RosComm::RosComm(ComponentMain* comp,int argc,char** argv)
{
  ...
  _comp=comp;
	...
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PP","MissionGlobalPath","sub"), 10, &RosComm::MissionGlobalPathCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PP","IEDPosAtt","sub"), 10, &RosComm::IEDPosAttCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PP","PosAttVel","sub"), 10, &RosComm::PosAttVelCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"PP","RPPPath","sub"), 10, &RosComm::RPPPathCallback,this));
