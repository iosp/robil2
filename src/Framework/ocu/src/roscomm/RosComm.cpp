	...
	: _inited(init(argc, argv)), _comp(comp)
{
	...
	_pub_TeleoperationControlMode=ros::Publisher(_nh.advertise<config::OCU::pub::TeleoperationControlMode>(fetchParam(&_nh,"OCU","TeleoperationControlMode","pub"),10));
...
void RosComm::publishTeleoperationControlMode( config::OCU::pub::TeleoperationControlMode &msg)
{
	_pub_TeleoperationControlMode.publish(msg);
}
