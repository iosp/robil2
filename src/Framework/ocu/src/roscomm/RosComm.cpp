...
RosComm::RosComm(ComponentMain* comp,int argc,char** argv)
{
  ...
  _comp=comp;
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"OCU","PosAttVel","sub"), 10, &RosComm::PosAttVelCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"OCU","Teleoperation","sub"), 10, &RosComm::TeleoperationCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"OCU","StatusData","sub"), 10, &RosComm::StatusDataCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"OCU","MissionStatus","sub"), 10, &RosComm::MissionStatusCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"OCU","Map","sub"), 10, &RosComm::MapCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"OCU","LocalPathPlan","sub"), 10, &RosComm::LocalPathPlanCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"OCU","IEDDetectionEvent","sub"), 10, &RosComm::IEDDetectionEventCallback,this));
	_sub_Map=ros::Subscriber(_nh.subscribe(fetchParam(&_nh,"OCU","IEDLocation","sub"), 10, &RosComm::IEDLocationCallback,this));
...
void RosComm::TeleoperationCallback(const config::OCU::sub::Teleoperation::ConstPtr &msg)
{
