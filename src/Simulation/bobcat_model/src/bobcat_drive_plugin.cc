...
double Linear_vell_values_array[] = { -0.80,    -1.32,    -1.77,    -1.82,	  -2.00,    -1.82,	  -1.77,     -1.32,    -0.80,    //t=-1.00
								  ...
								  //r=-1.00    r=-0.70   r=-0.40  r=-0.20	  r=0.00    r=0.20	 r=0.40     r=0.70    r=1.00
double Angular_vell_values_array[] = {-1.00,    -0.40,     -0.17,   -0.03 		0.00,     0.03	   0.17,      0.40,    	1.00,    //t=-1.00
